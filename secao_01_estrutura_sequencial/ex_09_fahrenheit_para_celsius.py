...
def transformar_para_celsius():
    ...
    temperatura = float(input('Informe uma temperatura em graus Fahrenheit:'))
    temperatura_celsius = int(5 * ((temperatura-32) / 9))
    print(f'Essa temperatura é de {temperatura_celsius:.2f} celsius')
